...
<style>
  ...
  .prefs :global(.crow.focused) { background: var(--surface-3); border-color: var(--accent); }
  ...
  .prefs :global(.sortbtn) { background: var(--surface-3); border: 1px solid color-mix(in srgb, var(--accent) 40%, transparent); color: var(--text); border-radius: 999px; padding: 4px 14px; cursor: pointer; font-size: clamp(11px, 1.1vw, 14px); font-weight: 700; }
  ...
  .prefs :global(.oskkey) { background: #0c1320; border: 2px solid var(--border); color: #dde5f0; border-radius: 8px; padding: 10px 0; font-size: clamp(15px, 1.6vw, 20px); font-weight: 700; cursor: pointer; text-transform: uppercase; }
  .prefs :global(.oskkey.special) { color: var(--accent); background: #11192b; }
  .prefs :global(.oskkey.focused) { border-color: var(--accent); background: var(--surface-3); color: #fff; box-shadow: 0 0 0 2px color-mix(in srgb, var(--accent) 60%, transparent); }
  ...
  .prefs-close { position: absolute; top: 14px; right: 14px; width: 34px; height: 34px; border-radius: 9px; background: var(--surface-3); border: 1px solid var(--border); color: var(--text-muted); cursor: pointer; font-size: 15px; line-height: 1; }
