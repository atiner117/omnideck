...
<style>
  ...
  .prefs :global(.crow.focused) { background: var(--surface); border-color: var(--accent); }
  ...
  .prefs :global(.ccat) { color: var(--text-label); font-size: clamp(11px, 1.1vw, 13px); text-transform: uppercase; letter-spacing: 1px; }
  .prefs :global(.cstate) { color: var(--text-dim); font-weight: 700; font-size: clamp(12px, 1.3vw, 15px); min-width: 72px; text-align: right; }
  .prefs :global(.cstate.on) { color: #6ee7a8; }
  .prefs :global(.cgroup) { color: var(--text-label); font-size: clamp(11px, 1.1vw, 13px); text-transform: uppercase; letter-spacing: 2px; font-weight: 700; padding: 12px 10px 4px; }
  ...
  .prefs :global(.sortbtn) { background: var(--surface); border: 1px solid color-mix(in srgb, var(--accent) 40%, transparent); color: var(--text-soft); border-radius: 999px; padding: 4px 14px; cursor: pointer; font-size: clamp(11px, 1.1vw, 14px); font-weight: 700; }
  ...
  .prefs :global(.phint) { color: var(--text-dim); font-size: clamp(11px, 1.1vw, 13px); margin: 3px 0 0; }
  .prefs :global(.confirm-btns) { display: flex; gap: 12px; justify-content: flex-end; margin: 14px 0 4px; }
  .prefs :global(.cbtn) { background: var(--surface); border: 1px solid var(--border); color: var(--text-soft); border-radius: 10px; padding: 9px 22px; cursor: pointer; font-size: clamp(13px, 1.4vw, 16px); font-weight: 700; }
  ...
  .prefs-close { position: absolute; top: 14px; right: 14px; width: 34px; height: 34px; border-radius: 9px; background: var(--surface); border: 1px solid var(--border); color: var(--text-muted); cursor: pointer; font-size: 15px; line-height: 1; }
